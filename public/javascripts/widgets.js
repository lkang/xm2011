...
__twttrlr(function (using, provide, loadrunner, define) {
    ...
    provide("xd/flash", function (a) {
        function b(a, b) {
            var c = b || Math.floor(Math.random() * 100),
                d = ['<object id="xdflashshim' + c + '" name="xdflashshim' + c + '"', 'type="application/x-shockwave-flash" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"', 'width="1" height="1" style="position:absolute;left:-9999px;top:-9999px;">', '<param name="movie" value="' + a + "&debug=" + window.__XDDEBUG__ + '"/>', '<param name="wmode" value="window"/>', '<param name="allowscriptaccess" value="always"/>', "</object>"].join(" ");
            return d
        }
        a({
            object: b
            ...
            i.prototype = new b.Connection, c.aug(i.prototype, {
                ...
                _createWindow: function () {
                    var a = {
                        ...
                        b, d, e, f = c.aug(c.aug({}, a), this.options.window),
                        g = screen.width,
                        i = screen.height;
    ...
    provide("util/widgetrpc", function (a) {
        using("util/params", function (b) {
            ...
            function l() {
                ...
                var b = a.success ||
                function () {}, c = a.timeout ||
                function () {}, d = a.nohub ||
                function () {}, f = a.attempt !== undefined ? a.attempt : h;
                if (!j() || e) return d(), !1;
                var k = i();
                f--;
                try {
        ...
        using("dom/cookie", "util/donottrack", function (b, c) {
            function f() {
                if (c()) b(d) && b(d, null, {
                    ...
                    var a = "v1:",
                        f = (+(new Date)).toString() + Math.round(Math.random() * 999999999);
                    b(d, a + f, {
                        domain: ".twitter.com",
                        path: "/",
                        expires: e
    ...
    provide("tfw/widget/tracking", function (a) {
        using("dom/cookie", "util/donottrack", "tfw/widget/guest_cookie", "util/widgetrpc", function (b, c, d, e) {
            ...
            var f = "twttr_",
                g = "//platform.twitter.com/widgets/images/",
                h = {
                    tweetbutton: "t.gif",
                    followbutton: "f.gif",
                    tweetembed: "e.gif"
        ...
        function (a, b) {
            ...
            function O(a) {
                var c = [],
                    ...
                    e = M(d),
                    f = e[1] || "*",
                    g, i, j, k = a.length && (h = a[0].match(x)) ? b.getElementById(h[1]) : b;
                if (!k) return c;
            ...
            var I = new H,
                ...
                K = new H,
                L = new H,
                S = "compareDocumentPosition" in B ?
            function (a, b) {
    ...
    provide("util/tweetparser", function (a) {
        using("util/qweryutil", function (b) {
            ...
            function e(a) {
                if (!a || !a.nodeName || a.nodeName.toLowerCase() != "blockquote") return !1;
                var c = {},
                    d = /twitter\.com\/(?:#!\/)?[a-zA-Z0-9_]{1,20}\/status(?:es)?\/(\d*)\/?/,
                    e = b.qwery("p", a);
                if (e.length) {
                    var g = e[0];
            ...
            function f(a) {
                var c = {},
                    d = /^\s*(.+)\s+\(@([a-zA-Z0-9_]{1,20})\)\s*/,
                    e = /twitter\.com\/(#!\/)?([a-zA-Z0-9_]{1,20})/;
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            var f = document.title,
                ...
                h = function (a) {
                    ...
                    var b = this.params(),
                        c = b.count || a.getAttribute("data-count"),
                        d = b.size || a.getAttribute("data-size"),
                        h = e.getScreenNameFromPage();
            ...
            h.prototype = new c.Base, b.aug(h.prototype, {
                ...
                render: function (a) {
                    var b = a.assetUrl() + "/widgets/tweet_button.1324331373.html#" + this.parameters(),
                        c = this.enableNewSizing ? this.dimensions.x[this.size]["horizontal" == this.count ? "horizontal" : "normal"] : this.langDimensions[this.lang][this.count],
                        d = this.dimensions.y[this.size]["vertical" == this.count ? "vertical" : "normal"],
                        e = this.titles.en,
                        f = this;
    ...
    provide("tfw/widget/tweetembed", function (a) {
        using("util/util", "tfw/widget/base", "tfw/widget/tweet", "util/uri", "util/insert", "tfw/data", "i18n/i18n", "util/params", "util/qweryutil", "util/tweetparser", "tfw/widget/tracking", function (b, c, d, e, f, g, h, i, j, k, l) {
            var m = "1.0",
                n = i.fromQuery(document.location),
                o = function (a) {
            ...
            o.prototype = new c.Base, b.aug(o.prototype, {
                init: function () {
                    function a(a) {
                        ...
                        g(c.lang, function (g) {
                            g.ender(function (h) {
                                var i = document.createElement("div"),
                                    j = g.autoFormat(c.width || c.element),
                                    k = g(a, {
                                        format: j,
                                        popupWebIntents: !1,
                                        tweetElement: "blockquote",
                                        showMedia: !c.hideMedia,
                                        showErrors: !1,
                                        showFollowButton: !e,
                                        renderActions: !e,
                                        partner: c.partner,
                                    ...
                                    l = '<div id="{{id}}" class="{{classNames}}" lang="{{lang}}" {{#style}}style="{{style}}"{{/style}}>{{{twt}}}</div>',
                                    m = {
                                        id: c.id,
                                        classNames: b,
                                        style: c.styleAttr.join(";"),
                                        lang: c.lang,
                                        twt: c.data.in_reply_to_data ? k.inReplyTo(a.in_reply_to_data).html() : k.html()
                                    };
                ...
                render: function (a) {
                    ...
                    using("lib/twt", function (a) {
                        a(b.lang, function () {
                            ...
                            b.data.twt_data_stub = !0, b.element = b.originElement, b.element = b.create(b.data, a), b.inReplyTo && !b.hideThread ? g.status({
                                id: [b.data.id_str, b.inReplyTo],
                                complete: function (c) {
                                    var d = c[0],
                                        e = c[1];
                                    if (d.error) return;
                                    d.in_reply_to_status_id_str === e.id_str ? (b.data = d, b.data.in_reply_to_data = e, b.element = b.create(b.data, a)) : d.in_reply_to_status_id_str ? g.status({
                                ...
                                id: b.data.id_str,
                                complete: function (c) {
                                    c.error ? (b.data.error = c.error, b.element = b.create(b.data, a)) : (b.data = c, c.in_reply_to_status_id_str && !b.hideThread ? g.status({
                                        id: c.in_reply_to_status_id_str,
                                        complete: function (d) {
    ...
    provide("tfw/widget/follow", function (a) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            var f = function (a) {
                    ...
                    var b = this.params(),
                        c = b.size || a.getAttribute("data-size");
            ...
            f.prototype = new c.Base, b.aug(f.prototype, {
                ...
                render: function (a) {
                    ...
                    var b = a.assetUrl() + "/widgets/follow_button.1324331373.html#" + this.parameters(),
                        c = this.width || this.dimensions.x[this.size],
                        d = this.dimensions.y[this.size],
                        e = this.titles.en,
                        f = this;
